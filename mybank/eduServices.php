                ...
                <div  class="electricPayment serv ">
                    ...
                    <div class="form-control">
                     ...
                     <input readonly type="number" name="" class="balance" value="<?php echo $balance?>">
                        ...
                        <input class="eleNumber" type="number"  min="" placeholder=" ادخل الرقم الجامعي" name="reportId">
                        <input class="price" type="number"  min="0" name="cash" placeholder="ادخل المبلغ ... أدنى قيمة يمكن دفعها 1000 جنيه" >
