    ...
    <section >
            <div class="container">
                <div class="customerPage">
                   ...
                   <input placeholder="اسم "  type="text" name="jobTitle" class="uname">
               </div>
               <div class="form-control">
                   <label for="telephone">  الوصف الوظيفي</label>
                   <input  type="text" name="jobDescription" class="telephone">
                </div>
                <div class="form-control">
                   <label for="telephone"> المرتب</label>
                   <input  type="number" name="salary" class="telephone">
                </div>
